    ...
    <div class="min-h-screen flex flex-col sm:flex-row">
        <div class="w-full sm:w-1/3 flex items-center justify-center p-6 bg-gray-100 dark:bg-gray-800">
            <div class="w-full max-w-md">
                <a href="/">
                    <img class="theme-image w-48 mx-auto mb-8" src="{{ asset('.storage/logins/stokle-logohitam.png') }}" alt="Theme Image">
                </a>
                {{ $slot }}
            </div>
        </div>
        <div 
            class="hidden sm:flex w-2/3 relative items-center justify-center p-12" 
